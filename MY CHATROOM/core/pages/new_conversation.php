...
<body>
<form class="new_con" action="" method="post">
	<input class="to" type="text" name="to" placeholder="To" value="<?php if(isset($_POST['to'])) { echo htmlentities($_POST['to']); } ?>">
	<br>
	<input class="to" type="text" name="subject" placeholder="件名" value="<?php if(isset($_POST['subject'])) { echo htmlentities($_POST['subject']); } ?>">
	<br>
	<textarea class="bo" name="body" value="<?php if(isset($_POST['body'])) { echo htmlentities($_POST['body']); } ?>"></textarea>
	<br>
